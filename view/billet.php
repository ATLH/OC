...
<section class="container-fluid" style="height: 500px; margin-top: 100px;">
	<div style="position: relative; height: 500px;" class="container d-flex justify-content-center align-items-center">
		<img style="position: absolute; width: 100%; border-radius: 5px; height: 500px;" src="<?php echo $billetView["url"]; ?>">
		<h3 style="position: absolute; z-index: 2; font-size: 40px;" class="text-white"><?php echo $billetView["titre"] ?></h3>
	</div>
</section>
