...
<div class="container" >
	<div class="row d-flex justify-content-center">
		<div class="col-lg-10">
			<form action="index.php?adminAction=chapitre&view=admin_view&chapter_ID=<?php echo $billetView["ID"];?>&set_cshapter=true" method="post" enctype="multipart/form-data">
		        ...
		        <textarea name="chapter_text" id="set_editor"><?php echo $billetView["chapter_text"]; ?></textarea>
		        <div class="col d-flex justify-content-center align-items-center col-lg-12">
					<button type="submit" name="update_chapter" class="btn btn-outline-dark m-2">Modifier</button>
				</div>  
	        </form>
		</div>
	</div>
