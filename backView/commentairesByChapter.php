...
<div class="container" style="margin-top: 100px;">
  ...
  Commentaire signaler <span class="badge badge-light"></span>
            </a>
		</div>
	</div>
</div>
...
<div class="container">
<?php while ( $comment = $CommentQuery->fetch() ) { ?>
		...
		<div class="col-lg-10">
			<div id="commentMedia" style="box-shadow: " class="rounded media  d-flex justify-content-center align-items-center">
				<div style="padding: 10px;" class="media-body">
					<div>
						<p style="font-size: 15px; margin: 0px;">De : <?php echo $comment["comment_lastname"]; ?></p>
						<p style="font-size: 15px;">Date : <?php echo $comment["comment_date"]; ?></p>
					</div>
					
					<p style="font-size: 15px;" ><?php echo $comment["comment"] ?>... </p>
				</div>
				<div class="d-flex justify-content-center align-items-center">
					<a title="Valider" href="index.php?adminAction=commentaires&allowComment=true&comment_ID=<?php echo $comment["ID"] ?>" class="btn btn-outline-success btn-sm d-block mr-4">Valider le commentaire</a>
				    <a title="Suprimer" href="index.php?adminAction=commentaires&allowComment=false&comment_ID=<?php echo $comment["ID"] ?>" class="btn btn-outline-danger d-block mr-4 btn-sm">Suprimer le commentaire</a>
				</div>
			</div>
		</div>
	</div>
