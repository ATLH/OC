...
<div class="container">
	<div class="row d-flex d-flex justify-content-center mt-5">
		<div class="col-lg-12">
			<h2 class="text-center mb-5 mt-5">Chapitres</h2>
		</div>
		<div class="col-lg-8">
			<p class="text-center">Cher(es) lecteurs-(trices) chaque semaine découvrez un tout nouveau chapitre  de mon dernier romans "Billet simple pour l'alaska".</p>
		</div>
	</div>
</div>
<section class="container">
	<div class="row d-flex justify-content-center flex-wrap align-items-center">
		<?php while ($chapter = $bddQuery->fetch()) { ?>
